...
import type { CreateTechnicianUseCaseRequestDTO, CreateTechnicianUseCaseResponseDTO } from '../dtos/create-technician-dto'
...
export class CreateTechnicianUseCase {
	...
	async execute({
		...
		const availabilityConfig = availability.length > 0
